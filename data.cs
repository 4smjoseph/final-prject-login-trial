...
namespace final_prject_login_trial
{
    class data
    {
        ...
        private string[] account = new string[9];
        public string sqlStr = "";
        private string path = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\IIMBA\source\repos\final prject login trial\final prject login trial\dataserver.mdf;Integrated Security=True";
